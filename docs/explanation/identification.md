...
:class: info
A different ordering gives different results, not because the data changed,
but because the identifying restrictions changed. Always justify your
ordering with domain knowledge.
:::
## Sign restrictions
