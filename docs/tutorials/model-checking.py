...
#   price level is I(1) or I(2) is an unsettled question in the unit-root
...
# %% [markdown]
# The two distributions overlap and BFMI is near 1, so this check passes. That is the point of
